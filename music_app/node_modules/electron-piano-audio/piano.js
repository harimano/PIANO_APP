...
function Piano() {
    ...
    this.recplay = function(n) {
        ...
        if (this.record && (retrans.compile(), this.default(), this.record = !1), getById("s1").value != "" && (this.play_pause = !1, this.play_cycle = !1, this.stp_cycle = !1, this.stp = !1, this.chord.length <= 1 && (this.msx = trans.compile(), this.time = this.msx[0], this.chord = this.msx[1], this.indexes = this.msx[2])), !this.play_pause)
    ...
    this.assist = function() {
        var n;
        if (this.as) {
            for (getById("assistd").innerHTML = "Key assist Off", n = 0; n < notes.w_n.length; n++) getById("a" + notes.w_c[n] + "d").innerHTML = "";
            for (n = 0; n < notes.b_n_.length; n++) getById("b" + notes.b_c[n] + "d").innerHTML = "";
            this.as = !1;
        } else {
            for (getById("assistd").innerHTML = "Key assist On", n = 0; n < notes.w_c.length; n++) getById("a" + notes.w_c[n] + "d").innerHTML = "<br/><br/><br/><br/><br/><br/>" + notes.w_n[n];
            for (n = 0; n < notes.b_c.length; n++) getById("b" + notes.b_c[n] + "d").innerHTML = "<br/>" + notes.b_n_[n] + "<br/>+<br/>&#8679";
            this.as = !0;
        }
    };
